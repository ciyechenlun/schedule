 ...
 *         描述：SendMsgTest.java <br />
 *         版本: 1.0.0 <br />
 *         日期：2013-6-20 上午11:16:37 <br />
 *         CopyRight © 2012 USTC SINOVATE SOFTWARE CO.LTD All Rights Reserved.
 */
...
public class SendMsgTest {
	...
	public static String msgSendTest() {
		...
		// 发送短信URL
		String url = String.format(Constant.MESS_SEND, content, teles,
				Constant.SMSS_SPID, Constant.SMSS_OSPID);
		try {
			// 发送短信
	 ...
	 */
	public static String sendMsg(String contentParam, String mobile) {
		...
		// 发送短信URL
		String url = String.format(MESS_SEND, content, Constant.SMSS_SPID,
				Constant.SMSS_OSPID);
		try {
			// 发送短信
