 ...
 */
@Repository
public class ScheduleLeaderDao extends HibernateBaseDaoImpl<ScheduleLeader, String> {
	...
	public void delBySchedule(String scheduleId){
		String sql="update tb_c_schedule_leader set del_flag='1' where schedule_id=?";
	...
	public void delByScheduleLeader(String scheduleId,int leaderId){
		String sql="update tb_c_schedule_leader set del_flag='1' where schedule_id=? and leader_id=?";
	...
	public List<Map<String,Object>> getBySchedule(String scheduleId){
		String sql="SELECT sl.*,l.leader_name " +
				"from tb_c_schedule_leader sl LEFT JOIN tb_c_leader l " +
