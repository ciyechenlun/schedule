...
public class HttpRequestStat {
	...
	public static CompositeType getCompositeType() throws JMException {
		...
		OpenType<?>[] indexTypes = new OpenType<?>[] { SimpleType.LONG,
				SimpleType.STRING, SimpleType.LONG,
				JMXUtils.getThrowableCompositeType(), SimpleType.DATE,
				SimpleType.LONG, SimpleType.LONG, SimpleType.DATE,
				SimpleType.LONG, SimpleType.DATE };

		String[] indexNames = { "ID", "URI",
				"ExecuteErrorCount",
				"ExecuteErrorLast",
				"ExecuteErrorLastTime" //
				, "ExecuteSuccessCount", "ExecuteSpanNanoMax",
				"ExecuteSpanMaxOccurTime", "ExecuteSpanNanoTotal",
				"ExecuteLastStartTime" };
		String[] indexDescriptions = indexNames;
		compositeType = new CompositeType("URIStatistic", "URI Statistic",
